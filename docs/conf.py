...
from reportapi import get_version, get_docs_version
...
title = _('ReportAPI Documentation')
about = _('Easy mechanism building reports in Django projects.')
...
modindex_common_prefix = [
    'reportapi.', 
    'reportapi.exceptions.'
    'reportapi.utuls.'
    'reportapi.templatetags.'
]
